...
class SlicesDataset(Dataset):
    ...
    def __init__(self, data):
        #print('Initialize the Slice Dataset')
        self.data = data
    ...
    def __getitem__(self, idx):
        ...
        """
        #print('start __get_Item__: load the slices information into an image and segment')
        slc = self.slices[idx]
        sample = dict()
        sample["id"] = idx
        ...
        # load the slices information into an inage and segment
        
        #image_info, seg_info = slc
